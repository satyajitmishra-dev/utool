...
export function SignupForm() {
  const { user, signUp, loginWithGoogle, loginWithFacebook, authInitializing } = useAuth();
    ...
    <AuthShell>
      <AuthCard>
        <AuthHeader 
          ...
          description="Get started with Utool for free" 
        />
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="bg-white/5 border border-white/10 text-white font-medium py-3 px-4 rounded-xl hover:bg-white/10 transition-all flex items-center justify-center disabled:opacity-50 text-sm"
          >
            {isGoogleLoading ? (
          ...
          >
            {isFacebookLoading ? (
              ...
              <>
                <svg className="w-5 h-5 mr-2 text-[#1877F2] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
