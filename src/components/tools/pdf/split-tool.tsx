    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 z-10 backdrop-blur-[6px] bg-slate-50/10 rounded-3xl flex flex-col items-center justify-center p-8 text-center min-h-[380px] pointer-events-none">
        <div className="glass-card max-w-sm p-8 rounded-3xl border border-slate-200/80 bg-white/90 shadow-lg flex flex-col items-center gap-4 animate-scale-in pointer-events-auto">
          ...
          <div>
            <h3 className="text-md font-extrabold text-slate-800 tracking-tight">Split PDF is Coming Soon</h3>
            <p className="mt-2 text-xs text-slate-500 leading-relaxed">
              We are currently calibrating the client-side parser to extract pages and ranges with maximum efficiency directly inside your browser.
            </p>
          </div>
          <Link
            href="/pdf-tools"
      ...
      <div className="opacity-40 pointer-events-none select-none filter blur-[1.5px] space-y-6">
                      ...
                      <div key={idx} className="flex items-center gap-3">
                        <div className="flex-1 grid grid-cols-2 gap-3">
                          <div className="space-y-1">
                            <label className="text-4xs font-bold text-slate-400 uppercase tracking-wider">
                              Start Page
                            </label>
                            <input
                              type="number"
                              ...
                              className="block w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold focus:border-indigo-500 focus:outline-none transition"
                            />
                          </div>
                          <div className="space-y-1">
                            <label className="text-4xs font-bold text-slate-400 uppercase tracking-wider">
                        ...
                        {ranges.length > 1 && (
                          <button
                            ...
                            className="mt-5 p-2 rounded-xl text-slate-400 hover:text-rose-600 hover:bg-rose-50/50 transition-colors"
        ...
        {processingState === "success" && (
          ...
          >
            ...
            <h3 className="text-lg font-bold text-slate-800">Split Action Completed!</h3>
