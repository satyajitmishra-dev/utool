...
export const blogPosts: Record<string, BlogPost> = {
  "how-to-merge-pdf-files-without-losing-quality": {
    ...
    title: "How to Merge PDF Files Free Without Quality Loss | Toolzy Guides",
  ...
  "how-to-create-custom-qr-codes-wifi": {
    ...
    title: "How to Create Custom Wi-Fi QR Codes (Auto-Login) | Toolzy Guides",
    ...
    paragraphs: [
      ...
      "Using Toolzy, you can personalize the colors to match your home styling or office brand, set the error correction to Medium or High for durability, and download the high-resolution file for printing. Place it in your conference room, lobby, or kitchen counter for instant auto-login."
    ],
  ...
  "ats-friendly-resume-writing-guide": {
    ...
    title: "ATS Resume Writing Guide: Pass the Bot & Win Interviews | Toolzy Guides",
  ...
  "url-shortening-best-practices": {
    ...
    title: "Link Shortening Best Practices: Increase CTR & Trust | Toolzy Guides",
    ...
    paragraphs: [
      ...
      "Using Toolzy, you can instantly convert messy tracking links into short, clean strings, share them across campaigns, and review click history directly from your dashboard workspace."
    ],
